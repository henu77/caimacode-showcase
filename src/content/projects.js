...
export const readmeContentByKey = Object.fromEntries(Object.entries(readmeModules).map(([path, content]) => {
...
export const projects = [
    {
        ...
        description: '把菜码编程的品牌介绍、项目预览、README 文档和视频内容整合成统一的展示门户。',
        cover: brandCover,
    ...
    },
    {
        ...
        description: '适合把某个编程教学案例拆成可视化作品页，方便展示截图、录屏和项目说明。',
        cover: teachingCover,
